# Generated by Django 2.1.5 on 2021-04-04 16:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type11', models.CharField(default=None, max_length=10)),
                ('type21', models.CharField(blank=True, default=None, max_length=10, null=True)),
                ...
                ('type12', models.CharField(default=None, max_length=10)),
                ('type22', models.CharField(blank=True, default=None, max_length=10, null=True)),
                ...
                ('type13', models.CharField(default=None, max_length=10)),
                ('type23', models.CharField(blank=True, default=None, max_length=10, null=True)),
                ...
                ('type14', models.CharField(default=None, max_length=10)),
                ('type24', models.CharField(blank=True, default=None, max_length=10, null=True)),
                ...
                ('type15', models.CharField(default=None, max_length=10)),
                ('type25', models.CharField(blank=True, default=None, max_length=10, null=True)),
                ...
                ('type16', models.CharField(default=None, max_length=10)),
                ('type26', models.CharField(blank=True, default=None, max_length=10, null=True)),
                ('gigantamax_factor6', models.IntegerField()),
                ('likes', models.ManyToManyField(related_name='team_like', to='builder.UserProfile')),
